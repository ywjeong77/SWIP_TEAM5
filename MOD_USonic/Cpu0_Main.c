...
// song array
const int song[] = { e5, d5s, e5, d5s, e5, b4, d5, c5, a4,a4, c4, e4, a4, b4,b4, e4, g4s, b4, c5,c5, e4, e5, d5s, e5, d5s, e5, b4, d5, c5, a4,a4, c4, e4, a4, b4,b4, e4, c5, b4, a4, a4 };
...
// button flag
unsigned char switch1_flag = 0;
unsigned char switch2_flag = 0;
...
int core0_main(void)
{
    ...
    while(1)
    {
        ...
        GTM_TOM0_CH11_SR0.U = song[song_idx];
        song_idx++;
...
void initERU6(void)
{
    ...
    SCU_EICR3.U &= ~(0x7 << INP0_BIT_LSB_IDX); // OGU2
